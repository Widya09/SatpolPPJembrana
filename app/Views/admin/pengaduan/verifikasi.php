...
<?= $this->section('title') ?>
<title>Pengaduan &mdash; Welcome Admin</title>
<?= $this->endSection() ?>
...
<div class="section-body">
  <div class="card">
    <div class="card-header">
      <h4>Buat Data Verifikasi Pengajuan</h4>
    </div>
    <div class="card-body col-md-6">
      <form onsubmit="return false" id="form" method="get" autocomplete="off" class="needs-validation" novalidate enctype="multipart/form-data">
        <?= csrf_field() ?>
  ...
  $(document).ready(function() {
    ...
    validator = $("#form").validate({
      submitHandler: function(form) {
        ...
        // var toast_text;
        var url = "<?php echo site_url('pengaduan/verifikasi') ?>/" + id_pengaduan
